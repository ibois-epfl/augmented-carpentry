...
# Class AIAC::CutCircularSawDepthVisualizer



[**ClassList**](annotated.md) **>** [**AIAC**](namespaceAIAC.md) **>** [**CutCircularSawDepthVisualizer**](classAIAC_1_1CutCircularSawDepthVisualizer.md)



_Visualizer for showing the depth of the cut._ 
...
| Type | Name |
| ---: | :--- |
|   | [**CutCircularSawDepthVisualizer**](#function-cutcircularsawdepthvisualizer) () <br> |
...
### function CutCircularSawDepthVisualizer 

```C++
AIAC::CutCircularSawDepthVisualizer::CutCircularSawDepthVisualizer () 
```
