...
| Type | Name |
| ---: | :--- |
|  std::map&lt; ACIMState, glm::vec4 &gt; | [**CUT\_EDGE\_COLOR**](#variable-cut_edge_color)   = = {
    {ACIMState::NOT\_DONE, glm::vec4(0.9f, 0.6f, 0.2f, 1.0f)},
    {ACIMState::CURRENT, glm::vec4(0.1f, 0.9f, 0.5f, 1.0f)},
    {ACIMState::DONE, glm::vec4(0.3f, 0.3f, 0.3f, 0.5f)}
}<br> |
|  std::map&lt; ACIMState, glm::vec4 &gt; | [**CUT\_FACE\_COLOR**](#variable-cut_face_color)   = = {
    {ACIMState::NOT\_DONE, glm::vec4(0.9f, 0.6f, 0.2f, 0.2f)},
    {ACIMState::CURRENT, glm::vec4(0.1f, 0.9f, 0.5f, 0.2f)},
    {ACIMState::DONE, glm::vec4(0.3f, 0.3f, 0.3f, 0.2f)}
}<br> |
|  std::map&lt; ACIMState, glm::vec4 &gt; | [**HOLE\_AXIS\_COLOR**](#variable-hole_axis_color)   = = {
    {ACIMState::NOT\_DONE, glm::vec4(0.1f, 0.9f, 0.9f, 1.0f)},
    {ACIMState::CURRENT, glm::vec4(0.1f, 0.9f, 0.5f, 1.0f)},
    {ACIMState::DONE, glm::vec4(0.3f, 0.3f, 0.3f, 0.5f)}
}<br> |
|  std::map&lt; ACIMState, glm::vec4 &gt; | [**HOLE\_CYLINDER\_COLOR**](#variable-hole_cylinder_color)   = = {
    {ACIMState::NOT\_DONE, glm::vec4(0.1f, 0.9f, 0.9f, 0.2f)},
    {ACIMState::CURRENT, glm::vec4(0.1f, 0.9f, 0.5f, 0.2f)},
    {ACIMState::DONE, glm::vec4(0.3f, 0.3f, 0.3f, 0.2f)}
}<br> |
